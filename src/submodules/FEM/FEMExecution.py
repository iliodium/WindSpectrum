...
if __name__ == "__main__":
    ...
    neu = NewmarkExecutionUnit(r"./FEA 115_4_0.dat")
    {"f_dat_file_path": "D:\\Projects\\WindSpectrum\\core\\FEA 115_4_0.dat", "method": 2, "dt": 0.05, "N": 32768,
     "elements": [
         {"alpha": 0.5, "beta": 0.5, "rho": 100000.0, "A": 1, "L": 5, "J": 1, "I_y": 0.1, "I_z": 0.1, "E": 17500000.0,
          "G": 105000000000.0},
         {"alpha": 0.5, "beta": 0.5, "rho": 100000.0, "A": 1, "L": 5, "J": 1, "I_y": 0.1, "I_z": 0.1, "E": 17500000.0,
          "G": 105000000000.0}], "newmark_alpha": 1, "newmark_delta": 1}
    neu.dt = 0.001
    neu += se
    neu += se
    neu.N = 32768
    subprocess_opened = FDMExecutionUtils.start_execution(
        ...
        r'D:\Projects\WindSpectrum\core\mechanics.exe',
        "./example.json"
    )
    ...
    print(subprocess_opened.stdout.readlines())
